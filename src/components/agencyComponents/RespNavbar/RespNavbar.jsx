...
import "../RespNavbar/RespNavbar.css";
export default function RespNavbar() {
  ...
  return (
    <>
      <section id="respnavbar">
        <nav className="navbar navbar">
          <div className="container-fluid">
            <a className="navbar-brand" href="#">
              <img src={Logo} alt="logo" />{" "}
            </a>
            <div className="search-box" onClick={searchtoggle}>
            ...
            >
              ...
              <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                  ...
                  <li className="nav-item" onClick={handleToggle2}>
                    <Link to="/agency/service" className="nav-link link" >
                      <span>Xidmətlər</span>{" "}
