...
export default function ProjectFirstRight() {
                    ...
                    projectdatas.map((project, index) => (
                        <div className="row" key={index}>
                            <div className="col-xl-6 col-md-6 col-inf" data-aos="fade-left">
                                ...
                                <ul className='col-ul'>
                                    {
                                        projectdatas[index].proprties.map(((item,i)=>(
                                            <li>{item}</li>
                                        )))
                                    }
                                </ul>
                            ...
                            <div data-aos="fade-right" className="col-xl-6 col-md-6 col-pic" style={{ backgroundImage: `url(${project.imgUrl})` }}>
                                <a  className='col-det c0l-det link' onClick={() => handleProjectClick(project)}>View Details<i className="fa-solid fa-arrow-right"></i></a>
                            </div>                    
                        </div>
                    ))
                }
