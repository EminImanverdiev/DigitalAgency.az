...
export default function CourseBgAnimation() {
  useEffect(() => {
    const animateCircle = () => {
  ...
  return (
    ...
    >
      <path
        d="M0,58.5c201.2,0,996.3,141.4,498.4,141.4S801.6,38.5,999.8,58.5s302.9,141.4,500.2,141.4
      s306.3-141.4,502.5-141.5s305.2,141.4,499.9,141.4c194.2,0,399.2-141.4,498.6-41.4"
        ...
        id="wire1"
      ></path>
      <circle class="circle1" cx="0" cy="0" r="30" fill="rgba(255,255,255,0.2)">
        <animateMotion
          dur="25s"
